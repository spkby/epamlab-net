namespace Collections1
{
    public class Constants
    {
        ...
        public const string EmptyDiscount = "";
        public const string Path = @"..\..\";
        public const string Ext = ".csv";
        public const string FileNotFoundHead = "File ";
        public const string FileNotFoundTail = " not found";
        public const string ErrorFailedConversion = "attempted conversion failed";
        public const string ErrorWrongNumber = "wrong number of values";
